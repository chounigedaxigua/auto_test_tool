...
int16_t INA219::getCurrent_raw() {
  uint16_t value;
/*
Sometimes a sharp load will reset the INA219, which will reset the cal register, meaning CURRENT and POWER will not be available ... avoid this by always setting a cal value even if it's an unfortunate extra step
*/
  wireWriteRegister(INA219_REG_CALIBRATION, ina219_calValue);
...
//   ina1->i2c_fd = wiringPiI2CSetup(0x43);
